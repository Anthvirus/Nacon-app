      ...
      <div className="flex flex-col xl:w-11/12 xxl:w-full mx-auto items-start">
        ...
        <div className="flex md:flex-row gap-x-12 gap-y-8 xl:gap-6 justify-center mx-2 sm:mx-16 md:mx-4 lg:mx-12 flex-col flex-wrap">
          {Services.map((Service) => (
            <div
              key={Service.name}
              className="flex-1 border group hover:grayscale-0 grayscale-25 overflow-hidden hover:shadow-xl w-auto md:min-w-[25rem] md:max-w-[27.5rem] lg:min-w-[22.5rem] lg:max-w-[25rem] h-[32rem]"
            >
              <img
                src={Service.image}

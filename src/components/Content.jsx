        ...
        <div className="w-11/12 lg:w-5/6 gap-x-12 gap-y-4 flex flex-col mt-8 mb-2 xl:mb-6 xl:mt-16">
          ...
          <div className="text-md md:text-2xl tracking-wide xl:leading-10 mx-2">
            ...
            <p>
              ...
              the collective efforts of the management. To connect businesses
              with international markets, to promote transparency in the
              maritime industry through technological innovations and ensure
              efficient delivery of shipments improving supply chain
              distribution. We have recruited and developed a team of
              professionals here at Nacon Investment, that allows our clients to
              track the progress of their shipment with us, ensuring
              transparency and shipment integrity. This move was part of the
              goals of the company, to ensure shipment integrity and remain as a
              leader in the maritime industry by embracing technological
              innovation.
              <br />
              <br />
              Our customer-centric approach guarantees that each shipment is
              treated with integrity and precision. With integrity being our
              watch word, you can be rest assured that our team will deliver
              your shipment to its desired destination.
            </p>
          </div>
        </div>
      </TransitionComponent>
          ...
          <div className="gap-4 border-b lg:pb-0 lg:border-b-0 pb-2 lg:gap-8 items-center lg:flex-row flex-col flex w-11/12 md:w-1/2 lg:min-w-5/6 h-max">
            ...
            <div className=" tracking-wide xl:leading-10 m-1 flex flex-col justify-center items-start h-full ">
              ...
              <p className="text-md md:text-xl xl:text-2xl">
                We are committed to providing efficient and cost-effective
                freight solutions through unmatched industry expertise. With
                precision and integrity being at our core, ensuring that every
                shipment meets highest standards, keeping client satisfaction as
                our top priority.
              </p>
            </div>
          </div>

      ...
      <div className="flex flex-col xl:w-11/12 xxl:w-full mx-auto items-center">
        ...
        <div className="flex md:flex-row gap-x-12 gap-y-8 xl:gap-12 justify-center items-center mx-4 sm:mx-16 md:mx-4 lg:mx-12 flex-col flex-wrap">
          {Services.map((Service) => (
            <div
              key={Service.name}
              className="flex-1 border group hover:grayscale-0 text-[var(--Accent)] bg-[var(--Secondary)] grayscale-25 overflow-hidden hover:shadow-xl w-11/12 md:min-w-[25rem] md:max-w-[27.5rem] lg:min-w-[20rem] lg:max-w-[25rem] xl:min-w-[25rem] h-[32rem]"
            >
              <img
                src={Service.image}
